...
if (isset($_GET['recipe_category'])) 
                    {
                        $recipe_field="recipe_category";
                        $recipe_type=$_GET['recipe_category'];
                    } 
                    else 
                    {
                        $recipe_field="recipe_cuisine";
                        $recipe_type=$_GET['recipe_cuisine'];
                    }


$results_per_page = 12;

$result=$d->select("recipe_details","$recipe_field='$recipe_type'","");
        ...
        <div class="section-content">
          <div class="row multi-row-clearfix">
            <?php 
                    ...
                    $q=$d->select("recipe_details","$recipe_field='$recipe_type'","LIMIT $this_page_first_result,$results_per_page");
