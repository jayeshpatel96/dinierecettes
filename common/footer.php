      ...
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="footer-widget">
              <h5 class="widget-title text-white">About Us<span class="line-bottom"></span></h5>
               <img class="mt-0" alt="" src="images/logo-wide2.png">
            <p class="font-12 mt-20">Dinie Recettes helps people to find variety of recipes using specification like recipe name, category, cuisine type or ingredients.</p>
            <a href="about.php" class="text-gray font-12"><i class="fa fa-angle-double-right text-orange"></i> Read more</a>
            
          </div>
        </div>
        <div class="col-sm-6 col-md-3">
          <div class="footer-widget">
            <h5 class="widget-title text-white">Social Media<span class="line-bottom"></span></h5>
            <nav>
          ...
          <div class="footer-widget">
            ...
            <nav>
              <ul class="list angle-double-right">
                ...
                <li><a href="chef_details.php">Our Chefs</a></li>
