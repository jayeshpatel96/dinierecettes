              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <input type="text" placeholder="Enter Your Email" id="email" name="email" required="" class="form-control">
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group text-center">
                      <button class="btn btn-colored btn-rounded btn-orange pl-30 pr-30" type="submit" name="forgot_email_verification">Submit</button>
                  </div>
